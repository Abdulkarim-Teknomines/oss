...
<link rel="stylesheet" href="{{ URL::asset('asst/css/bootstrap.min.css') }}">
<!-- style css -->
<link rel="stylesheet" href="{{ URL::asset('assts/css/style.css') }}">
<!-- Responsive-->
<link rel="stylesheet" type="text/css" href="{{ URL::asset('assts/css/responsive.css') }}">
<!-- fevicon -->
<link rel="icon" type="image/gif" href="{{ URL::asset('asst/images/fevicon.png') }}">
<!-- Scrollbar Custom CSS -->
<link rel="stylesheet" type="text/css" href="{{ URL::asset('asst/css/jquery.mCustomScrollbar.min.css') }}">
<!-- Tweaks for older IEs-->
<link rel="stylesheet" href="https://netdna.bootstrapcdn.com/font-awesome/4.0.3/css/font-awesome.css">
<!-- owl stylesheets --> 
<link rel="stylesheet" type="text/css" href="{{ URL::asset('asst/css/owl.carousel.min.css') }}">

<link rel="stylesheet" type="text/css" href="{{ URL::asset('asst/css/owl.theme.default.min.css') }}">
...
<body>
  <!--header section start -->
    ...
    <!--footer section end -->
    <!-- Javascript files-->
    <script src="{{ URL::asset('asst/js/jquery.min.js') }}"></script>
    <script src="{{ URL::asset('asst/js/popper.min.js') }}"></script>
    <script src="{{ URL::asset('asst/js/bootstrap.bundle.min.js') }}"></script>
    <script src="{{ URL::asset('asst/js/jquery-3.0.0.min.js') }}"></script>
    <script src="{{ URL::asset('asst/js/plugin.js') }}"></script>
    
    <!-- sidebar -->
    <script src="{{ URL::asset('asst/js/jquery.mCustomScrollbar.concat.min.js') }}"></script>
    <script src="{{ URL::asset('asst/js/custom.js') }}"></script>
    <!-- javascript --> 
    <script src="{{ URL::asset('asst/js/owl.carousel.js') }}"></script>
