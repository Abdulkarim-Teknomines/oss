        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                <div class="mb-3 row">
                    ...
                    <label for="expiry_date" class="col-md-3 col-form-label text-md-end text-start"><strong>Register Date:</strong></label>
                ...
                <div class="mb-3 row">
                    ...
                    <label for="expiry_date" class="col-md-3 col-form-label text-md-end text-start"><strong>Expiry Date:</strong></label>
                    <div class="col-md-2" style="line-height: 35px;">
                        {{ $user[0]->expiry_date }}
                    </div>
                </div>
