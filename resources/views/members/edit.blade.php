...
<div class="row justify-content-center">
    <div class="col-md-11">
        <div class="card card-primary">
            ...
            <div class="card-body">
                <form action="{{ route('members.update', $user[0]->id) }}" method="post">
                    @csrf
                    @method("PUT")
                    <div class="row mb-3">
                        <label for="name" class="col-md-3 col-form-label text-md-end text-start">Name <span style="color:red">*</span></label>
                        <div class="col-md-4">
                        <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name',$user[0]->name) }}" placeholder="Name" autocomplete="off">
                            @if ($errors->has('name'))
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-4">
                        <input type="text" class="form-control @error('middle_name') is-invalid @enderror" id="middle_name" name="middle_name" value="{{ old('middle_name',$user[0]->middle_name) }}" placeholder="Middle Name" autocomplete="off">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-4">
                        <input type="text" class="form-control @error('mobile_number') is-invalid @enderror" id="mobile_number" name="mobile_number" value="{{ old('mobile_number',$user[0]->mobile_number) }}" placeholder="Mobile Number" autocomplete="off">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-4">
                            <div class="input-group birth_date" id="birth_date" data-target-input="nearest">
                                <input type="text" name="birth_date" class="form-control select2 select2-hidden-accessible state @error('birth_date') is-invalid @enderror  datetimepicker-input" data-target="#birth_date" placeholder="YYYY-MM-DD" readonly="true" value="{{ old('birth_date') ? old('birth_date') : $user[0]->birth_date }}"/>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-4">
                          <input type="email" class="form-control @error('email') is-invalid @enderror" id="email" name="email" value="{{ old('email',$user[0]->email) }}" placeholder="Email Address" autocomplete="off">
                            @if ($errors->has('email'))
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-4">
                          <input type="text" class="form-control @error('father_name') is-invalid @enderror" id="father_name" name="father_name" value="{{ old('father_name',$user[0]->member->father_name) }}" placeholder="Father Name" autocomplete="off">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-4">
                          <input type="text" class="form-control @error('mother_name') is-invalid @enderror" id="mother_name" name="mother_name" value="{{ old('mother_name',$user[0]->member->mother_name) }}" placeholder="Mother Name" autocomplete="off">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-4">
                            <div class="input-group anniversary_date" id="anniversary_date" data-target-input="nearest">
                                <input type="text" name="anniversary_date" class="form-control select2 select2-hidden-accessible state datetimepicker-input" data-target="#anniversary_date" placeholder="YYYY-MM-DD" readonly="true" value="{{ old('anniversary_date') ? old('anniversary_date') : $user[0]->member->anniversary_date }}"/>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-4">
                            <select id="country" class="form-control @error('country_id') is-invalid @enderror country_id" name="country_id" style="width: 100%;" data-select2-id="1" tabindex="-1" aria-hidden="true">
                                ...
                                @if (old('country_id',$user[0]->country_id) == $data->id)
                    ...
                    <div class="col-md-4">
                        <textarea class="form-control select2 select2-hidden-accessible state @error('address') is-invalid @enderror " name="address" placeholder="Address">{{ old('address') ? old('address') : $user[0]->address }}</textarea>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-4">
                        <input type="text" class="form-control" id="pancard_number" name="pancard_number" value="{{ old('pancard_number',$user[0]->pancard_number) }}" placeholder="Pancard Number" autocomplete="off">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-4">
                            <input type="text" class="form-control" id="adharcard_number" name="adharcard_number" value="{{ old('adharcard_number',$user[0]->adharcard_number) }}" placeholder="Adharcard Number" autocomplete="off">
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        var country_id = "{{old('country_id')?old('country_id'):$user[0]->country_id}}";
        var state_id = "{{old('state_id')?old('state_id'):$user[0]->state_id}}";
        var city_id = "{{old('city_id')?old('city_id'):$user[0]->city_id}}";
        $.ajax({
