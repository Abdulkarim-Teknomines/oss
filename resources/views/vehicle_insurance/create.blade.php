            ...
            <div class="card-body">
                <form action="{{ route('vehicle_insurance.store_vehicle_insurance') }}" method="post">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-4">
                        <input type="text" class="form-control @error('insurance_company_name') is-invalid @enderror" id="insurance_company_name" name="insurance_company_name" value="{{ old('insurance_company_name') }}" placeholder="Insurance Company Name" autocomplete="off">
