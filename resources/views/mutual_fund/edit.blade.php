        ...
        <div class="card card-primary">
            ...
            <form action="{{ route('mutual_fund.update_mutual_fund', $mutual_fund->id) }}" method="post">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-4">
                        <input type="text" class="form-control @error('folio_number') is-invalid @enderror" id="folio_number" name="folio_number" value="{{ old('folio_number',$mutual_fund->folio_number) }}" placeholder="Folio Number" autocomplete="off">
