            ...
            <div class="card-body">
                <div class="mb-3 row">
                    ...
                    <div class="col-md-4" style="line-height: 35px;">
                        {{ $mutual_fund[0]->user->user_id }}
                    </div>
                </div>
                <div class="mb-3 row">
                    <label for="roles" class="col-md-3 col-form-label text-md-end text-start"><strong>User Name:</strong></label>
                    <div class="col-md-4" style="line-height: 35px;">
                        {{ $mutual_fund[0]->user->name }} {{ $mutual_fund[0]->user->middle_name }} {{ $mutual_fund[0]->user->surname }}
                    </div>
                </div>
                <div class="mb-3 row">
