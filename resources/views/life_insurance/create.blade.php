        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                <form action="{{ route('life_insurance.store_life_insurance') }}" method="post">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-4">
                            <div class="input-group birth_date" id="birth_date" data-target-input="nearest">
                                <input type="text" name="birth_date" data-toggle="datetimepicker" class="form-control select2 select2-hidden-accessible state @error('birth_date') is-invalid @enderror  datetimepicker-input" data-target="#birth_date" placeholder="YYYY-MM-DD" value="{{ old('birth_date') ? old('birth_date') : '' }}" readonly/>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-4">
                            <div class="input-group ppt_end_date" id="ppt_end_date" data-target-input="nearest">
                                <input type="text" name="ppt_end_date" data-toggle="datetimepicker" class="form-control select2 select2-hidden-accessible state @error('ppt_end_date') is-invalid @enderror  datetimepicker-input" data-target="#ppt_end_date" placeholder="YYYY-MM-DD" value="{{ old('ppt_end_date') ? old('ppt_end_date') : '' }}" readonly/>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-4">
                            <div class="input-group nominee_dob" id="nominee_dob" data-target-input="nearest">
                                <input type="text" name="nominee_dob" data-toggle="datetimepicker" class="form-control select2 select2-hidden-accessible state @error('nominee_dob') is-invalid @enderror  datetimepicker-input" data-target="#nominee_dob" placeholder="YYYY-MM-DD" value="{{ old('nominee_dob') ? old('nominee_dob') : '' }}" readonly/>
                    ...
                    <div class="mb-3 row">
                        <input type="submit" class="col-md-2 offset-md-10 btn btn-primary" value="Add Life Insurance">
                    </div>
                </form>
            </div>
        </div>
...
$('#policy_number').change( function() {
    ...
    $.ajax({
        url: "{{route('fetchLifeInsurancePolicy')}}",
        type: "POST",
        data: {
