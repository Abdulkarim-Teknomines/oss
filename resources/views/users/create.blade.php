            ...
            <div class="card-body">
                <form action="{{ route('users.store') }}" method="post">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-4">
                        <input type="text" class="form-control @error('emergency_contact_number') is-invalid @enderror" id="emergency_contact_number" name="emergency_contact_number" value="{{ old('emergency_contact_number') }}" placeholder="Emergency Contact Number" autocomplete="off">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-4">
                        <input type="text" class="form-control @error('pancard_number') is-invalid @enderror" id="pancard_number" name="pancard_number" value="{{ old('pancard_number') }}" placeholder="Pancard Number" autocomplete="off">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-4">
                            <input type="text" class="form-control @error('adharcard_number') is-invalid @enderror" id="adharcard_number" name="adharcard_number" value="{{ old('adharcard_number') }}" placeholder="Adharcard Number" autocomplete="off">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-4">
                            <select id="country" class="form-control @error('country_id') is-invalid @enderror country_id" name="country_id" style="width: 100%;"  aria-hidden="true" data-select2-id="1" >
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-4">
                            <select id="state" name="state_id" class="form-control select2 select2-hidden-accessible state_id @error('state_id') is-invalid @enderror state_id" style="width: 100%;" aria-hidden="true" data-select2-id="1" >
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-4">
                            <select id="city" name="city_id" class="form-control select2 select2-hidden-accessible city_id @error('city_id') is-invalid @enderror city_id" style="width: 100%;" aria-hidden="true" data-select2-id="1" >
                    ...
                    <div class="mb-3 row">
                        <label for="roles" class="col-md-3 col-form-label text-md-end text-start">Roles <span style="color:red">*</span></label>
                        <div class="col-md-4">           
                            <select class="form-control select2 select2-hidden-accessible @error('roles') is-invalid @enderror roles"  aria-label="Roles" id="roles" name="roles[]">
                                <option value="">-- Select Role --</option>
                                @forelse ($roles as $role)
                                <!-- @if($role=='Admin' || $role=='Manager' || $role=='Agent') -->
                                    <!-- @if ($role!='Super Admin') -->
                                        @if(($role=='Admin' && Auth::user()->hasRole('Super Admin'))||($role=='Manager' && Auth::user()->hasRole('Admin'))||($role=='Agent' && Auth::user()->hasRole('Manager')))
                    ...
                    <div class="mb-3 row">
                        <input type="submit" class="col-md-2 offset-md-10 btn btn-primary" value="Add User">
                    </div>
                </form>
            </div>
        </div>
