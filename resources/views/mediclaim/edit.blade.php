        ...
        <div class="card card-primary">
            ...
            <form action="{{ route('mediclaim.update_mediclaim', $mediclaim->id) }}" method="post">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-4">
                        <input type="number" min="0" class="form-control @error('sr_no') is-invalid @enderror" id="sr_no" name="sr_no" value="{{ old('sr_no',$mediclaim->sr_no) }}" placeholder="Sr No." autocomplete="off">
                            @if ($errors->has('sr_no'))
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-4">
                            <div class="input-group birth_date" id="birth_date" data-target-input="nearest">
                                <input type="text" name="birth_date" data-toggle="datetimepicker" class="form-control select2 select2-hidden-accessible state @error('birth_date') is-invalid @enderror  datetimepicker-input" data-target="#birth_date" placeholder="YYYY-MM-DD" readonly="true" value="{{ old('birth_date') ? old('birth_date') : $mediclaim->birth_date }}"/>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-4">
                            <div class="input-group policy_start_date" id="policy_start_date" data-target-input="nearest">
                                <input type="text" name="policy_start_date" data-toggle="datetimepicker" class="form-control select2 select2-hidden-accessible state @error('policy_start_date') is-invalid @enderror  datetimepicker-input" data-target="#policy_start_date" placeholder="YYYY-MM-DD" value="{{ old('policy_start_date') ? old('policy_start_date') : $mediclaim->policy_start_date }}"/>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-4">
                            <div class="input-group policy_end_date" id="policy_end_date" data-target-input="nearest">
                                <input type="text" name="policy_end_date" data-toggle="datetimepicker" class="form-control select2 select2-hidden-accessible state @error('policy_end_date') is-invalid @enderror  datetimepicker-input" data-target="#policy_end_date" placeholder="YYYY-MM-DD" value="{{ old('policy_end_date') ? old('policy_end_date') : $mediclaim->policy_end_date }}" readonly/>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-4">
                        <input type="text" class="form-control @error('policy_number') is-invalid @enderror" id="policy_number" name="policy_number" value="{{ old('policy_number',$mediclaim->policy_number) }}" placeholder="Policy Number" autocomplete="off">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-4">
                        <input type="number" min="0" class="form-control @error('sum_assured') is-invalid @enderror" id="sum_assured" name="sum_assured" value="{{ old('sum_assured',$mediclaim->sum_assured) }}" placeholder="Sum Assured" autocomplete="off">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-4">
                          <input type="number" min="0" class="form-control @error('premium_amount') is-invalid @enderror" id="premium_amount" name="premium_amount" value="{{ old('premium_amount',$mediclaim->premium_amount) }}" placeholder="Premium Amount" autocomplete="off">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-4">
                          <input type="number" min="0" class="form-control @error('yearly_premium_amount') is-invalid @enderror" id="yearly_premium_amount" name="yearly_premium_amount" value="{{ old('yearly_premium_amount',$mediclaim->yearly_premium_amount) }}" placeholder="Yearly Premium Amount" autocomplete="off" readonly>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-4">
                        <input type="number" min="0" class="form-control" id="agent_mobile_number" name="agent_mobile_number" value="{{ old('agent_mobile_number',$mediclaim->agent_mobile_number) }}" placeholder="Agent Mobile Number" autocomplete="off">
                        </div>
                    </div>
                    <div class="mb-3 row">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-4">
                        <input type="number" min="0" class="form-control" id="branch_contact_number" name="branch_contact_number" value="{{ old('branch_contact_number',$mediclaim->branch_contact_no) }}" placeholder="Branch Contact Number" autocomplete="off">
                        </div>
                    </div>
                    <div class="mb-3 row">
...
$('#policy_number').change( function() {
    ...
    var mediclaim_id = "{{$mediclaim->id}}";
    
    $.ajax({
        url: "{{route('fetchPolicyUsers')}}",
        type: "POST",
        data: {
            policy_number: policy_num,mediclaim_id:mediclaim_id,
            _token: '{{csrf_token()}}'
        },
        dataType: 'json',
