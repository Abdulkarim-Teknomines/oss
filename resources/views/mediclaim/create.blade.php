            ...
            <div class="card-body">
                <form action="{{ route('mediclaim.store_mediclaim') }}" method="post">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-4">
                        <input type="text" class="form-control @error('policy_number') is-invalid @enderror" id="policy_number" name="policy_number" value="{{ old('policy_number') }}" placeholder="policy_number" autocomplete="off">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-4">
                          <input type="text" class="form-control @error('premium_amount') is-invalid @enderror" id="premium_amount" name="premium_amount" value="{{ old('Premium Amount') }}" placeholder="Premium Amount" autocomplete="off">
